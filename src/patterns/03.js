import React, { useState, useLayoutEffect, createContext, useCallback, useMemo, useContext } from 'react';
...
const useClapAnimation = ({ clapEl, countEl, clapTotalEl }) => {
	...
	// useLayoutEffect makes everything smoother
	useLayoutEffect(() => {
...
// Deconstruct Provider from createContext
...
const MediumClap = ({ children }) => {
	...
	// onClick event handler (updates state) and call animations
	...
	// JSX
	return (
		// wrap JSX elements in our Provider
